...
export async function fetchQuestions(
    ...
    try {
        ...
        console.log(
            "[fetchQuestions] Token preview:",
            token.trim().substring(0, 10) + "...",
        );
        ...
        if (!apiResponse.data || !Array.isArray(apiResponse.data)) {
            return {
                success: false,
                error: `[${requestUid}] Invalid data structure received from API`,
            };
        }
        ...
        console.log(
            "[fetchQuestions] Successfully fetched",
        ...
        if (axios.isAxiosError(error)) {
            ...
            if (axiosError.code === "ECONNABORTED") {
                return {
                    success: false,
                    error: `[${requestUid}] Request timeout - please try again`,
                };
            }
